...
class Board:
    ...
    def __init__(self, rows, cols):
        ...
        # actualizar movimiento es pra que cuando un jugador selecione una pieza y esta se mueva entonces mande una instruccion de que se
        #movio y cambie la pieza en la matris 
